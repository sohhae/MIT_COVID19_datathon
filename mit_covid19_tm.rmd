...
```{r}
news_data<- read.csv("sample_data.csv",stringsAsFactors = FALSE, sep = ",")
...
stop_words2= as.data.frame(c("every","also","","city","china","york","wuhan","coronavirus","virus","covid","people","person"))
